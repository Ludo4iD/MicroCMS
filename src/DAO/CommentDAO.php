...
class CommentDAO extends DAO 
{
	...
	{
        $commentData = array(
            'art_id' => $comment->getArticle()
				->getId(),
				'usr_id' => $comment->getAuthor()
					->getId(),
        ...
        if ($comment->getId())
		{
            ...
            $this->getDb()
				->update('t_comment', $commentData, array(
